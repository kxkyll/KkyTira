...
/**
 *
 * JoustavaTaulukko olio korvaa Sanahaku ohjelmassa tarvittavat osat ArrayList
 * rakenteesta
 *
 * @author Kati
 *
...
public class JoustavaTaulukko {
     ...
     * yksiulotteinen taulukko, oletuskoko 100 alkiota i, joka on indeksi
     * taulukon ensimmäiseen tyhjään alkioon ja ilmaisee samalla myös taulukon
     * täyttöasteen
     *
     * @author Kati
     */
    ...
    /**
     * Konstruktori alustaa joustavanTaulukon 100 alkion mittaiseksi ja indeksin
     * i arvoon 0
     */
    ...
    /**
     * Konstruktori, joka alustaa joustavan taulukon Tiedosto-tyyppisillä
     * olioilla
     *
     * @param t
     */
    ...
    /**
     * Metodi getI palauttaa indeksin i arvon, joka osoittaa ensimmäiseen
     * tyhjään alkioon
     *
     * @return i
     */
    ...
    /**
     * Metodi setI asettaa indeksin i arvon
     */
    public int setI(int indeksi) {
        return this.i = indeksi;
    }

    /**
     * Metodi getJoustavaListaItem palauttaa parametrina saadun indeksin
     * osoittaman taulukon alkion, jos alkio on listaan lisättyjen alkioiden
     * arvoalueella
     *
     * @param ind jonka osoittamaa alkiota pyydetään
     * @return joustavaTaulukko[ind] palauttaa joustavanTaulukon alkion tai
     * arvon null jos indeksi osoittaa ohi taulukkoon lisättyjen alkioiden
     */
    ...
    /**
     * Metodi lisaaJoustavaanTaulukkoon lisää parametrina saavansa objektin
     * joustavanTaulukon seuraavaan tyhjään paikkaan, jos taulukko on täynnä,
