        ...
        if (sana.length() > 0) {
          ...
          //System.out.println("sana: " + sana);
            ...
            for (int i = 0; i < sana.length(); i++) {
                DT_TrieSolmu uusiLapsi = nykyinenSolmu.etsiKirjain(sana.charAt(i)); // etsitään löytyykö solmua joka jo sisältää kirjaimen
                ...
                if (uusiLapsi != null) {
                   ...
                   // System.out.println("uusiLapsi on null");
                    uusiLapsi = new DT_TrieSolmu(sana.charAt(i)); // ei löytynyt: tehdään uusi lapsi
